...
transporter.verify((error, success) => {
  if (error) {
    console.warn("Nodemailer SMTP configuration warning/error in emailService.js:", error.message);
  } else {
    console.log("Nodemailer SMTP server is ready in emailService.js.");
  }
});
