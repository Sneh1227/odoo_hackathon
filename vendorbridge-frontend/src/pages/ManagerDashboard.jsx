...
const ManagerDashboard = () => {
  ...
  const user = userJson ? JSON.parse(userJson) : { fullName: "Manager Approver", role: "Manager" };
      ...
      <nav className="navbar navbar-expand-lg navbar-dark bg-secondary shadow-sm px-4">
        ...
        <div className="ms-auto d-flex align-items-center gap-3">
          ...
          {user.profilePicture ? (
            ...
            <div
              className="rounded-circle bg-white text-secondary fw-bold d-flex align-items-center justify-content-center"
